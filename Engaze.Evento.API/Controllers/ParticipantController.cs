...
namespace Engaze.Evento.API.Controllers
{
    ...
    public class ParticipantController : ServiceControllerBase
    {
        ...
        {
            await commandDispatcher.Dispatch(new LeaveEvento(eventoId, participantId));
            return new StatusCodeResult(StatusCodes.Status204NoContent);
        }
        ...
        {
            await commandDispatcher.Dispatch(new UpdateParticipantState(eventoId, participantId, acceptanceState));
            return new StatusCodeResult(StatusCodes.Status204NoContent);
        }
    }
}